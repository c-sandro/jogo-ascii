...
function moverMonstro(){
    if(xouy == "y" || coordPlayer[0] == coordMonstro[0]){
        if(coordPlayer[1] > coordMonstro[1]){
            if(mapa[coordMonstro[0]][coordMonstro[1] + 1] != "*" && mapa[coordMonstro[0]][coordMonstro[1] + 1] != "H"){
                coordMonstro[1]++ 
            }
            ...
            if(coordPlayer[0] > coordMonstro[0]){
                if(mapa[coordMonstro[0] + 1][coordMonstro[1]] != "*" && mapa[coordMonstro[0] + 1][coordMonstro[1]] != "H"){
                   coordMonstro[0]++  
                }
